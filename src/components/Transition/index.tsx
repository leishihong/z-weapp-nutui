import { isValidElement, ReactElement, ReactNode, useMemo, memo, useState, FC } from 'react';
...
const Transition: FC<TransitionProps> = (props) => {
  ...
  const transactionName = useMemo(() => (isTransitionPreset(name) ? `transition-${name}` : name), [name]);
