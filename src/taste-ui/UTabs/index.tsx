...
const UTabs: FC<Partial<TabsProps>> = (props) => {
	...
	const findInd = useMemo(
		() => dataSource.findIndex((t: any) => t[valueKey] == value),
		[dataSource, value]
	);
				...
				>
					{map(dataSource, (item, index: number) => {
						return (
							...
							>
								<View
									className={cx[`${b()}__titles-item__line`]}
									style={{ background: color }}
								/>
								<View
									className={cls(cx[`${b()}__titles-item__text`], {
