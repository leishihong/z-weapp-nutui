			...
			<View className={cls(cx[b()])}>
				<View className={cls(cx[b('user')])}>
					...
					<View className={cx[b('user-info')]}>
						<View className={cls(cx[b('user-info-header')], 'ellipsis')}>
							JEANJEAN
						</View>
						<View className={cx[b('user-info-signature')]}>
							一段个人简介描述~
						</View>
					</View>
				...
				<View className={cx[b('body')]}>
					<UCard
						...
						extra={
							<View className={cx[b('community-extra')]}>
								我的社团
								<Avatar
									src="https://s1.ax1x.com/2023/02/14/pSoLGg1.png"
									shape="square"
									size={32}
								/>
							</View>
					...
					>
						<View className={cx[b('community-body')]}>
							<Avatar
								onAvatar={() =>
									Taro.navigateTo({ url: URL['system-settings'] })
								}
					...
					<UCard title="我加入的社团" className={cx[b('join-community')]}>
						<ScrollView
							...
							scrollWithAnimation
							enableFlex
							className={cx[b('join-community-scroll')]}
						>
							<View className={cx[b('join-community-grid')]}>
								<View className={cx[b('join-community-grid-item')]}>
									<Avatar
										...
										size={100}
									/>
									<View className={cx[b('join-community-grid-item-title')]}>
										加入的社团
									</View>
								</View>
								<View className={cx[b('join-community-grid-item')]}>
